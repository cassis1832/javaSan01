...
public class UsuarioController implements BaseController<UsuarioDto, Integer, VwUsuario> {
    ...
    @Override
    @GetMapping
    public ResponseEntity<ApiResponse<UsuarioDto>> getById(Integer integer) {
        return null;
    }

    @Override
    @PostMapping
    public ResponseEntity<ApiResponse<UsuarioDto>> create(UsuarioDto usuarioDto) {
        return null;
    }

    @Override
    @PutMapping
    public ResponseEntity<ApiResponse<UsuarioDto>> update(UsuarioDto usuarioDto) {
        return null;
    }
    ...
    @Override
    @GetMapping("/list")
    public ResponseEntity<ApiResponse<List<UsuarioDto>>> getList(Map<String, String> filtros) {
        return null;
    }

    @Override
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<Page<VwUsuario>>> getPage(Pageable pageable, Map<String, String> filtros) {
        return null;
    }
